...
QT_MOC_LITERAL(1, 8, 21), // "changeDisplayedDialog"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "setIndex"
QT_MOC_LITERAL(4, 40, 2) // "i_"

    },
    "MDialog\0changeDisplayedDialog\0\0setIndex\0"
    "i_"
};
...
void MDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeDisplayedDialog((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MDialog::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MDialog::changeDisplayedDialog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MDialog::changeDisplayedDialog(int _t1)
{
